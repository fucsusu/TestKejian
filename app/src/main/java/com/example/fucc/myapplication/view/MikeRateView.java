...
public class MikeRateView extends View {
    ...
    public MikeRateView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public MikeRateView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        canvas.drawArc(penWidth / 2, penWidth / 2, width - penWidth / 2, height - penWidth / 2, -180, angle, false, paint);
    }
